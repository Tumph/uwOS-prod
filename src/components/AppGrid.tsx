...
export function AppGrid({ searchText }: AppGridProps) {
  ...
  const apps = useMemo<AppData[]>(() => [
    ...
    {
      name: 'UW Pilot',
      url: 'https://uwpilot.vercel.app/',
      iconClass: 'uwpilot',
      iconContent: (
        <div className="icon-inner">
          <svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{transform: 'translateY(-5px)'}}>
            {/* Cap */}
            <path d="M4 14l8-4 8 4-8 4-8-4z" fill="#4285F4" />
            {/* Tassel */}
            <path d="M12 14v6" stroke="#4285F4" strokeWidth="2.5" />
            {/* Gown */}
            <path d="M7 14v4c0 2 2 3 5 3s5-1 5-3v-4" stroke="#4285F4" strokeWidth="2.5" />
          </svg>
        </div>
      )
    },
      ...
      iconContent: (
        <div className="icon-inner">
          <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 14l6-6 6 6" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M6 18l6-6 6 6" stroke="#FFD700" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
      )
    },
    {
      ...
      iconContent: (
        <div className="icon-inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 9.470000267028809 158.9600067138672 35.78999710083008" width="50" height="20">
            <g fill="#FFFFFF" stroke="#FFFFFF" strokeWidth="2">
              <g transform="translate(0, 0)">
                <path d="M0 45.26L0 9.47L4.74 9.47L4.74 41.04L22.36 41.04L22.36 45.26L0 45.26ZM28.10 45.26L28.10 9.47L53.98 9.47L53.98 13.70L32.84 13.70L32.84 24.66L52.64 24.66L52.64 28.86L32.84 28.86L32.84 41.04L54.81 41.04L54.81 45.26L28.10 45.26ZM57.42 45.26L71.17 9.47L76.27 9.47L90.92 45.26L85.52 45.26L81.35 34.42L66.38 34.42L62.45 45.26L57.42 45.26M67.75 30.57L79.88 30.57L76.15 20.65Q74.44 16.14 73.61 13.23Q72.92 16.67 71.68 20.07L67.75 30.57ZM94.78 45.26L94.78 9.47L110.64 9.47Q115.43 9.47 117.92 10.44Q120.41 11.40 121.90 13.84Q123.39 16.28 123.39 19.24Q123.39 23.05 120.92 25.66Q118.46 28.27 113.31 28.98Q115.19 29.88 116.16 30.76Q118.24 32.67 120.09 35.52L126.32 45.26L120.36 45.26L115.63 37.82Q113.55 34.59 112.21 32.89Q110.86 31.18 109.80 30.49Q108.74 29.81 107.64 29.54Q106.84 29.37 105.00 29.37L99.51 29.37L99.51 45.26L94.78 45.26M99.51 25.27L109.69 25.27Q112.94 25.27 114.77 24.60Q116.60 23.93 117.55 22.45Q118.51 20.97 118.51 19.24Q118.51 16.70 116.66 15.06Q114.82 13.43 110.84 13.43L99.51 13.43L99.51 25.27ZM130.76 45.26L130.76 9.47L135.62 9.47L154.42 37.57L154.42 9.47L158.96 9.47L158.96 45.26L154.10 45.26L135.30 17.14L135.30 45.26L130.76 45.26Z"/>
              </g>
            </g>
          </svg>
        </div>
